    ...
    <div class="container h-100 d-lg-flex flex-lg-column justify-content-lg-center">
      <div class="row flex-column flex-lg-row">
        ...
        <div class="col-12 col-lg-7 pt-3 p-3 pt-lg-0">
          ...
          <form method="POST" action="mail.php" onsubmit="return mail()">
            <p>感謝您對J's Hotel 台北傑斯旅店的支持!如有需要為您服務的地方或建議，歡迎留言讓我們知道，謝謝!</p>
            <div class="form-group">
              <label for="service_name">姓名</label>
              <input type="text" class="form-control" id="service_name" name="service_name" placeholder="請輸入姓名" required>
            </div>
            <div class="form-group">
              <label for="service_email">電子信箱</label>
              <input type="email" class="form-control" id="service_email" name="service_email" placeholder="請輸入電子信箱" required>
            </div>
            <div class="form-group">
              <label for="service_phone">聯絡電話</label>
              <input type="text" class="form-control" id="service_phone" placeholder="請輸入聯絡電話" required>
            </div>
            <div class="form-group">
              <label for="service_required">需求內容</label>
              <textarea class="form-control" id="service_required" name="service_required" rows="3" placeholder="請輸入需求內容" required></textarea>
            </div>
